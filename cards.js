let cards = [
    ...
    ['mí', 'me (obj prep)'],
    ['lo', '[3rd person] (dir obj-m)'],
    ['tener', 'to have'],
    ['como', 'like, as'],
    ['estar', 'to be (location, change from norm)'],
    ['me', 'me (obj)'],
    ['más', 'more'],
    ['este', 'this (m) [esta (f)]'],
    ['le', '[3rd person] (indir obj)'],
    ['hacer', 'to do, make'],
    ['se', '[“reflexive” marker]'],
    ['yo', 'I (subj)'],
    ['o', 'or'],
    ...
    ['sí', 'yes'],
    ['año', 'year'],
    ['ti', 'you (obj prep-sg/+fam)'],
    ['te', 'you (obj/+fam)'],
    ['también', 'also'],
    ['qué', 'what?, which?, how (+ADJ)!'],
    ['alguno', 'some, a few'],
    ['nos', 'us (obj)'],
    ['tu', 'your (+fam)'],
    ['sin', 'without'],
    ...
    ['cuando', 'when'],
    ['querer', 'to want, love'],
    ['vez', 'time (specific occurrence); en v. de: instead of'],
    ['hasta', 'until, up to, even (ADV)'],
    ['la', '[3rd person] (dir obj-f)'],
    ...
    ['esperar', 'to wait, hope (for), expect'],
    ['nunca', 'never, ever'],
    ...
    ['largo', 'long'],
    ['semana', 'week'],
    ['partido', 'party, group, (sports) match'],
    ['acabar', 'a. de V: to have just Ved; finish'],
    ['explicar', 'to explain'],
    ['cuyo', 'whose'],
    ['razón', 'reason; tener r.: to be right'],
    ['negro', 'black'],
    ...
    ['mas', 'but, however'],
    ['estudiar', 'to study'],
    ['hermano', 'brother, [pl] siblings'],
    ['ley', 'law, bill, rule'],
    ['sentido', 'sense, feeling'],
    ['incluso', 'including, even (ADV)'],
    ...
    ['comer', 'to eat'],
    ['acuerdo', 'accord; de a.: in agreement'],
    ...
    ['comprar', 'to buy'],
    ['necesario', 'necessary'],
    ['camino', 'road, route, path'],
    ['dinero', 'money'],
    ['pie', 'foot, base'],
    ['final', 'al f.: finally, in the end'],
    ...
    ['modo', 'way, manner; de m. que: so that'],
    ['rico', 'rich, tasty'],
    ['ojalá', 'hopefully'],
    ...
    ['pesar', 'a p. de: in spite of'],
    ['establecer', 'to establish'],
    ['seguro', 'safe, sure, secure'],
    ['vista', 'view, sight'],
    ...
    ['orden', 'order; sequence (m), religious (f)'],
    ['mal', 'badly'],
    ...
    ['gracia', '(pl) thank you; grace, favor'],
    ['santo', 'saint (m)'],
    ['diez', 'ten'],
    ['tercero', 'third'],
    ['espacio', 'space, room'],
    ...
    ['compartir', 'to share'],
    ['cuánto', 'how much?'],
    ['capital', 'capital; city (f), money (m)'],
    ['cabo', 'end, bit; llevar a c.: to carry out'],
    ['inglés', 'English'],
    ['fácil', 'easy'],
    ['partir', 'to divide, leave; a p. de: starting'],
    ['lengua', 'language, tongue, strip (of land)'],
    ['curso', 'course, direction'],
    ['mandar', 'to send, order'],
    ['término', 'term (language), end'],
    ['decisión', 'decision'],
    ['dolor', 'pain, ache, sorrow'],
    ['director', 'director, manager, principal'],
    ['participar', 'to participate'],
    ['causa', 'cause'],
    ['personaje', 'character (e.g. movie)'],
    ['rostro', 'face, countenance'],
    ['ocasión', 'opportunity, occasion'],
    ['página', 'page'],
    ['atrás', 'back, behind, ago'],
    ['llenar', 'to fill'],
    ['esfuerzo', 'effort, endeavor'],
    ['maestro', 'teacher (m), master'],
    ['siete', 'seven'],
    ...
    ['control', 'control'],
    ['niña', 'child, young girl'],
    ['mal', 'evil'],
    ['norte', 'north'],
    ['plan', 'plan'],
    ['entregar', 'to deliver'],
    ['carta', 'letter, (playing) card'],
    ['colegio', '(high) school, college'],
    ['policía', 'police, police force, police officer'],
    ['llorar', 'to cry'],
    ['enorme', 'enormous, vast'],
    ['figura', 'figure'],
    ['capacidad', 'capacity'],
    ['comentar', 'to comment on'],
    ['orientar', 'to guide, show the way'],
    ...
    ['desaparecer', 'to disappear, vanish'],
    ...
    ['medida', 'measure; a m. que: to the extent'],
    ...
    ['abandonar', 'to abandon, leave (a place)'],
    ['fijar', 'to set, fix, [se] notice'],
    ...
    ['parar', 'to stop (moving)'],
    ['rey', 'king'],
    ['éxito', 'success'],
    ['constituir', 'to constitute, consist of'],
    ...
    ['duro', 'hard'],
    ['común', 'common'],
    ['pena', 'trouble; valer la p.: be of worth'],
    ['red', 'network, net, system'],
    ['pieza', 'piece, part'],
    ['golpe', 'hit, strike, punch'],
    ['economía', 'economy, economics, thriftiness'],
    ['árbol', 'tree'],
    ...
    ['nación', 'nation'],
    ['ministro', '(government) secretary, minister'],
    ...
    ['par', 'pair, couple (m); a la p.: at same time'],
    ...
    ['simple', 'simple, mere, simpleminded'],
    ['comercial', 'commercial, shopping'],
    ['riesgo', 'risk'],
    ...
    ['escapar', 'to escape'],
    ['causar', 'to cause, bring about'],
    ['grave', 'serious, solemn'],
    ['viajar', 'to travel'],
    ['cámara', 'camera, chamber'],
    ['vía', 'road, way; por v.: by means'],
    ['ejército', 'army'],
    ['comida', 'food, meal'],
    ['caballo', 'horse'],
    ...
    ['consejo', 'advice, council, counsel'],
    ...
    ['agosto', 'August'],
    ['pasado', 'past, last'],
    ['radio', 'radio; set (m), communication (f)'],
    ['emplear', 'to employ'],
    ['máximo', 'maximum'],
    ...
    ['café', 'coffee, cafe'],
    ['contenido', 'contents, content'],
    ['cincuenta', 'fifty'],
    ['pintura', 'painting, paint'],
    ['marido', 'husband'],
    ['diario', 'newspaper'],
    ['recorrer', 'to travel, cover (distance)'],
    ['hallar', 'to find (out)'],
    ...
    ['coger', 'to hold, take, catch'],
    ['suyo', 'his, hers, yours (−fam), theirs'],
    ['tratamiento', 'treatment, processing'],
    ...
    ['venta', 'sale'],
    ['sonido', 'sound'],
    ['característica', 'characteristic, aspect'],
    ['cerca', 'close, near'],
    ['instrumento', 'instrument'],
    ['bello', 'beautiful, fine'],
    ['visión', 'vision'],
    ['sonrisa', 'smile'],
    ['factor', 'factor, cause, influence'],
    ...
    ['grito', 'cry, shout, scream'],
    ['habitación', 'room, bedroom, habitat'],
    ['olor', 'smell, odor, fragrance'],
    ['estadounidense', 'U.S., American'],
    ['oficina', 'office'],
    ['tranquilo', 'calm, tranquil, relaxed'],
    ['caja', 'bank, box, safe'],
    ['prestar', 'to lend'],
    ...
    ['víctima', 'victim, casualty'],
    ['líder', 'leader'],
    ['básico', 'basic, essential'],
    ['equilibrar', 'to balance'],
    ['participación', 'participation, involvement'],
    ['idioma', '(specific) language'],
    ...
    ['seco', 'dry, arid'],
    ['ordenar', 'to put in order, organize'],
    ['completamente', 'completely'],
    ['indio', 'Indian'],
    ['caber', 'to fit (into)'],
    ['positivo', 'positive'],
    ['lista', 'list, roster, roll'],
    ['coche', 'car, carriage'],
    ['respetar', 'to respect'],
    ['inversión', 'investment, outlay'],
    ['directamente', 'directly, straight away'],
    ['límite', 'limit'],
    ['jardín', 'garden'],
    ['placer', 'pleasure'],
    ['patio', 'courtyard, playground, yard'],
    ['encargar', 'to entrust, [se] take charge of'],
    ['concluir', 'to conclude, finish'],
    ['asistir', 'to attend'],
    ['cerrado', 'closed'],
    ['encantar', 'to be very pleasing to'],
    ['literario', 'literary'],
    ...
    ['componer', 'to compose, be part of'],
    ...
    ['pese', 'in spite of'],
    ['británico', 'British'],
    ['enterar', 'to find out [se]'],
    ['fenómeno', 'phenomenon'],
    ['musical', 'musical'],
    ['marzo', 'March'],
    ['espejo', 'mirror, reflection'],
    ['obstante', 'however, nevertheless'],
    ['ejercer', 'to practice, exercise'],
    ['periodista', 'journalist'],
    ['ministerio', 'ministry'],
    ['situar', 'to situate, place, locate'],
    ['género', 'sort, gender, genre'],
    ['dueño', 'owner, landlord (m)'],
    ['luna', 'moon'],
    ['tender', 'to tend to, lay out'],
    ['octubre', 'October'],
    ['concreto', 'concrete, real'],
    ['plazo', 'deadline, installment'],
    ['hola', 'hello, hi'],
    ['terrible', 'terrible'],
    ['recomendar', 'to recommend'],
    ['aprobar', 'to pass (test), approve'],
    ['incorporar', 'to incorporate, include'],
    ['comisión', 'commission, committee'],
    ['bien', 'goods, property, benefit'],
    ['sexual', 'sexual'],
    ['diverso', 'different, various, several'],
    ...
    ['viernes', 'Friday'],
    ['cercano', 'near'],
    ['disco', 'disc, disk, record'],
    ['hambre', 'hunger, starvation'],
    ['eliminar', 'to eliminate, exclude'],
    ...
    ['poesía', 'poetry, poem'],
    ['destruir', 'to destroy, ruin'],
    ['reciente', 'recent'],
    ['fundar', 'to found, base'],
    ['doble', 'double'],
    ['tendencia', 'tendency, style'],
    ['vehículo', 'vehicle, car'],
    ['temer', 'to fear'],
    ['aparte', 'apart, aside, separately'],
    ...
    ['pérdida', 'loss'],
    ['cuello', 'neck, collar'],
    ['compromiso', 'compromise, engagement'],
    ['ángel', 'angel'],
    ['comprobar', 'to verify, prove'],
    ['rechazar', 'to reject'],
    ['cargar', 'to load (up), carry'],
    ['raíz', 'root'],
    ['integrar', 'to integrate, fit in'],
    ['temperatura', 'temperature'],
    ['señal', 'sign, mark, token'],
    ['financiero', 'financial'],
    ['frecuencia', 'frequency'],
    ['discutir', 'to argue, discuss'],
    ['banda', '(musical) band, sash'],
    ['confirmar', 'to confirm'],
    ['transmitir', 'to transmit, broadcast'],
    ['arreglar', 'to fix, arrange'],
    ['secretario', 'secretary'],
    ['candidato', 'candidate'],
    ['exposición', 'exhibition, display'],
    ['apuntar', 'to point, note, aim'],
    ['daño', 'harm, injury, damage'],
    ['club', 'club, society'],
    ['atravesar', 'to cross'],
    ...
    ['punta', 'tip, point'],
    ['juventud', 'youth'],
    ['acaso', 'by chance, maybe'],
    ['pintar', 'to paint'],
    ['industrial', 'industrial'],
    ['torno', 'en t. a: around'],
    ['lindo', 'pretty, nice, lovely'],
    ['intelectual', 'intellectual'],
    ['derecho', 'right, straight'],
    ['referencia', 'reference, allusion'],
    ['sujeto', 'subject, individual'],
    ['despedir', 'to say goodbye (to), dismiss'],
    ['religión', 'religion'],
    ['probablemente', 'probably'],
    ['baño', 'bathroom, bath, swim'],
    ['enseñanza', 'teaching, instruction'],
    ['pan', 'bread'],
    ['aportar', 'to provide, contribute'],
    ['vino', 'wine'],
    ['demanda', 'petition, request, demand'],
    ...
    ['temporada', 'season, period, time'],
    ['denominar', 'to call, name'],
    ...
    ['regla', 'rule, ruler, regulation'],
    ['amarillo', 'yellow'],
    ['líquido', 'liquid'],
    ['cadena', 'chain'],
    ['barco', 'boat, ship'],
    ['dividir', 'to divide'],
    ['marchar', 'to go, leave, march'],
    ...
    ['noviembre', 'November'],
    ['carga', 'load, charge, cargo'],
    ['educativo', 'educational'],
    ['arrancar', 'to start (machine), uproot'],
    ['doña', 'courtesy title (f), Mrs.'],
    ...
    ['sumar', 'to add up, amount to'],
    ['primo', 'cousin'],
    ['obligación', 'obligation'],
    ['acudir', 'to attend, go to, frequent'],
    ['gestión', 'management, step, negotiation'],
    ['atrever', 'to dare'],
    ['concierto', 'concert, concerto'],
    ['asociación', 'association'],
    ['constitución', 'constitution'],
    ['imperio', 'empire, fortune'],
    ['estrategia', 'strategy'],
    ['prometer', 'to promise'],
    ...
    ['diálogo', 'dialogue, conversation'],
    ['correcto', 'correct, suitable'],
    ['volar', 'to fly'],
    ...
    ['reino', 'kingdom, reign'],
    ['zapato', 'shoe'],
    ['muestra', 'proof, sample, sign'],
    ['intenso', 'intense, acute'],
    ...
    ['vacío', 'empty, vacant'],
    ['quinto', 'fifth'],
    ['ingresar', 'to join, deposit, admit'],
    ['sesenta', 'sixty'],
    ['relato', 'tale, story'],
    ['ése', 'that one (m), [ésa (f)]'],
    ['besar', 'to kiss'],
    ['publicación', 'publication'],
    ['cerebro', 'brain'],
    ['conferencia', 'conference, lecture'],
    ['practicar', 'to practice'],
    ['ingreso', 'entrance, admission, income'],
    ['comparar', 'to compare'],
    ...
    ['proceder', 'to proceed, start'],
    ['pájaro', 'bird'],
    ['poderoso', 'powerful'],
    ['vaso', '(drinking) glass, vase'],
    ['laboral', 'labor, industry'],
    ['colombiano', 'Colombian'],
    ['biblioteca', 'library'],
    ['consiguiente', 'por c.: consequently'],
    ['alzar', 'to lift, raise'],
    ...
    ['procedimiento', 'procedure, proceedings'],
    ['doler', 'to hurt'],
    ['animar', 'to cheer up'],
    ...
    ['accidente', 'accident, irregularity'],
    ['compra', 'shopping, buy, purchase'],
    ['brindar', 'to offer'],
    ['modificar', 'to modify'],
    ['debate', 'debate'],
    ['facilitar', 'to facilitate'],
    ['encerrar', 'to shut (in)'],
    ['acontecimiento', 'event, happening'],
    ['colgar', 'to hang (up)'],
    ['ignorar', 'to be unaware'],
    ['felicidad', 'happiness'],
    ['arena', 'sand'],
    ['mentira', 'lie'],
    ...
    ['lavar', 'to wash'],
    ['anciano', 'old person'],
    ['influir', 'to (have) influence'],
    ['gordo', 'fat, thick'],
    ['sugerir', 'to suggest, hint at'],
    ['electoral', 'electoral'],
    ...
    ['once', 'eleven'],
    ['cristal', 'glass, crystal, window'],
    ['permanente', 'permanent'],
    ['urbano', 'urban, city, urbane'],
    ['gozar', 'to enjoy'],
    ['palacio', 'palace'],
    ['infantil', 'of children, childlike, infantile'],
    ['costo', 'price, cost, expense'],
    ['firma', 'company, signature, signing'],
    ['órgano', 'organ'],
    ['limpio', 'clean'],
    ...
    ['puente', 'bridge'],
    ['signo', 'sign, mark, symbol'],
    ['tuyo', 'yours (sg/+fam)'],
    ['carretera', 'highway, road'],
    ['orquesta', 'orchestra, dance band'],
    ['hierro', 'iron'],
    ...
    ['deuda', 'debt'],
    ['ilusión', 'illusion, hope, dream'],
    ['honor', 'honor, honesty'],
    ['oferta', 'offer, bid, supply'],
    ['montón', 'lot of, heap, pile'],
    ['auténtico', 'authentic'],
    ['capa', 'layer, coat'],
    ['vuelo', 'flight'],
    ...
    ['revisar', 'to check, revise, inspect'],
    ['código', 'code'],
    ['disminuir', 'to decrease, diminish'],
    ['habitual', 'usual, habitual, customary'],
    ['presentación', 'presentation, introduction'],
    ['vuestro', 'your (pl/+fam)'],
    ['descansar', 'to rest'],
    ['nacimiento', 'birth, origin'],
    ['gris', 'gray, gloomy'],
    ['judío', 'Jew'],
    ['inútil', 'useless'],
    ['estimar', 'to estimate, hold in esteem'],
    ['largo', 'a lo l.: throughout, length'],
    ['posteriormente', 'afterwards'],
    ['absurdo', 'absurd'],
    ['respirar', 'to breathe'],
    ['ubicar', 'to find, locate'],
    ['dominio', 'power, control'],
    ['eterno', 'eternal'],
    ['presupuesto', 'budget'],
    ['división', 'division'],
    ['metal', 'metal'],
    ...
    ['acceder', 'to consent, agree, accede'],
    ['operar', 'to operate'],
    ['empleado', 'employee'],
    ['variar', 'to change, vary'],
    ['previo', 'previous'],
    ['aventura', 'adventure'],
    ['capitán', 'captain, chief'],
    ...
    ['cura', 'priest (m), cure (f)'],
    ['universal', 'universal'],
    ['latino', 'Latin'],
    ['suave', 'soft, gentle, mild'],
    ['efectivamente', 'in fact, actually, indeed'],
    ['judicial', 'judicial'],
    ['amenazar', 'to threaten'],
    ['motor', 'engine, motor'],
    ['acostar', 'to put/go to bed'],
    ['arrojar', 'to throw, fling'],
    ['triunfo', 'triumph, victory'],
    ['brillante', 'brilliant, shiny, sparkling'],
    ['vacío', 'emptiness, void'],
    ['bolsillo', 'pocket'],
    ['negativo', 'negative, pessimistic'],
    ['repente', 'de + r.: suddenly'],
    ['identidad', 'identity'],
    ['alrededor', 'surrounding area, vicinity'],
    ['plato', 'plate, dish'],
    ['municipal', 'municipal, town'],
    ['caliente', 'hot, warm, spirited'],
    ...
    ['variedad', 'variety'],
    ['miércoles', 'Wednesday'],
    ['impulsar', 'to push, promote, drive'],
    ['cansado', 'tired, tiresome'],
    ['figurar', 'to appear, represent, figure (in)'],
    ['consumir', 'to consume, take in'],
    ['instalación', 'installation, facilities'],
    ['cuidado', 'care, carefulness'],
    ['reina', 'queen'],
    ['experto', 'expert'],
    ['asomar', 'to appear, show, stick (out)'],
    ['apreciar', 'to appreciate'],
    ['riqueza', 'riches, wealth'],
    ['votar', 'to vote'],
    ['rincón', 'corner, nook'],
    ['curiosidad', 'curiosity, quaintness'],
    ['partida', 'game, match, departure'],
    ['naturalmente', 'naturally'],
    ['mental', 'mental'],
    ['agencia', 'agency, branch'],
    ['actuación', 'performance, acting'],
    ['tasa', 'rate, fee, levy'],
    ['manifestación', 'protest, manifestation'],
    ['busca', 'search, hunt'],
    ['rodilla', 'knee'],
    ['convenir', 'to be agreeable, be convenient'],
    ['interpretación', 'interpretation, interpreting'],
    ['diputado', 'deputy, member'],
    ['lentamente', 'slowly'],
    ['empresario', 'manager, entrepreneur'],
    ['ruta', 'route'],
    ['empujar', 'to push, shove'],
    ['destinar', 'to assign, appoint'],
    ['pintor', 'painter'],
    ['criticar', 'to criticize'],
    ['archivo', 'archive, file, filing cabinet'],
    ['caracterizar', 'to characterize, portray'],
    ['pantalla', 'screen, monitor'],
    ['llave', 'key, faucet, wrench'],
    ['sucio', 'dirty, filthy, underhanded'],
    ['ánimo', 'zest, spirit, heart'],
    ['conversar', 'to converse, talk'],
    ['carro', 'car, cart'],
    ['alimentar', 'to feed, support'],
    ['tremendo', 'tremendous, dreadful, huge'],
    ['dulce', 'sweet'],
    ...
    ['cola', 'line, queue, tail'],
    ['crítico', 'critical'],
    ['columna', 'column, spine'],
    ['escala', 'scale, ladder, rank'],
    ['humor', 'mood, humor'],
    ['esencial', 'essential'],
    ['camisa', 'shirt'],
    ['muro', '(outer) wall, rampart'],
    ['rueda', 'wheel'],
    ['sustancia', 'substance, essence'],
    ['testigo', 'witness'],
    ['botella', 'bottle, flask'],
    ['aguantar', 'to endure, put up with'],
    ['estatal', 'state, government-owned'],
    ['comunista', 'communist'],
    ['denunciar', 'to denounce'],
    ['fumar', 'to smoke'],
    ['descender', 'to descend'],
    ['ejecutar', 'to execute, carry out'],
    ['inclinar', 'to bow, tilt, incline'],
    ['chileno', 'Chilean'],
    ['acariciar', 'to stroke, fondle, caress'],
    ['espiritual', 'spiritual'],
    ['justificar', 'to justify, excuse'],
    ['entorno', 'environment, surroundings'],
    ['húmedo', 'humid, damp'],
    ['sustituir', 'to substitute, replace'],
    ['verdaderamente', 'truly'],
    ['llamado', 'call, calling'],
    ['amenaza', 'threat'],
    ['jornada', '(working) day, shift'],
    ['únicamente', 'only'],
    ['perdido', 'lost'],
    ['rayo', 'ray, beam, lightning'],
    ['preferible', 'preferable'],
    ['potencia', 'power, potential'],
    ['conformar', 'to conform'],
    ['semejante', 'similar, such, alike'],
    ['vidrio', 'glass, pane'],
    ['imaginación', 'imagination, fantasy'],
    ['oración', 'prayer'],
    ['sobrevivir', 'to survive, outlive'],
    ['reflexión', 'reflection'],
    ['pelear', 'to fight, struggle'],
    ['corredor', 'broker, corridor, runner'],
    ['relativo', 'relative'],
    ...
    ['escoger', 'to choose'],
    ['externo', 'external, outward'],
    ['violento', 'violent'],
    ['junta', 'meeting, conference, seam'],
    ['familiar', 'relative'],
    ['claro', 'of course, clearly'],
    ['conforme', 'in agreement with'],
    ['fruta', 'fruit'],
    ['protagonista', 'protagonist, main character'],
    ['tropa', 'troops, forces'],
    ['descubrimiento', 'discovery'],
    ['sacerdote', 'priest'],
    ['ligero', 'light (in weight), slight'],
    ['avenida', 'avenue'],
    ['reconocimiento', 'recognition, acknowledgment'],
    ['respectar', 'to concern'],
    ['típico', 'typical'],
    ['excepción', 'exception'],
    ['ingeniero', 'engineer'],
    ['pobreza', 'poverty, lack, scarcity'],
    ['bar', '(snack) bar, café'],
    ['setenta', 'seventy'],
    ['significativo', 'significant, meaningful'],
    ['fabricar', 'to manufacture'],
    ['quejar', 'to complain'],
    ['procurar', 'to try, seek'],
    ['cariño', 'love, affection'],
    ['lucir', 'to show (off), shine'],
    ['débil', 'weak'],
    ['calcular', 'to calculate, figure out'],
    ['oler', 'to smell'],
    ...
    ['colonia', 'colony, cologne'],
    ['sano', 'healthy, wholesome'],
    ['plástico', 'plastic'],
    ['registro', 'register, record'],
    ['combinar', 'to combine'],
    ['firme', 'firm, steady'],
    ['condenar', 'to convict, condemn'],
    ['ochenta', 'eighty'],
    ['liberar', 'to free, liberate'],
    ['tensión', 'tension, stress, strain'],
    ['divino', 'divine'],
    ['herida', 'wound'],
    ['sesión', 'session, meeting'],
    ['conectar', 'to connect, plug in'],
    ['evidentemente', 'evidently, obviously'],
    ['oh', 'oh'],
    ['fila', 'line, row, file'],
    ['contexto', 'context'],
    ['hilo', 'thread, yarn, wire'],
    ['vergüenza', 'embarrassment'],
    ['administrativo', 'administrative'],
    ['engañar', 'to trick, deceive'],
    ['raza', 'race, lineage'],
    ['cáncer', 'cancer'],
    ['juntar', 'to bring together'],
    ['caída', 'fall, drop, falling'],
    ['regalo', 'gift, present'],
    ['castellano', 'Castilian, Spanish'],
    ['angustia', 'anguish, distress'],
    ['elaborar', 'to make, develop'],
    ...
    ['juzgar', 'to judge'],
    ['suma', 'sum, amount, summary'],
    ['cita', 'appointment, date, quotation'],
    ['completar', 'to complete'],
    ['resolución', 'resolution'],
    ['examen', 'examination, exam +o'],
    ['patrón', 'employer, landlord, patron saint'],
    ['azúcar', 'sugar'],
    ['distribución', 'distribution'],
    ['composición', 'composition, makeup, essay'],
    ['diseñar', 'to design, develop'],
    ['alcalde', 'mayor'],
    ['facilidad', 'ease, facility'],
    ['inferior', 'lower, inferior'],
    ['convocar', 'to convene, summon'],
    ['fracaso', 'failure, collapse'],
    ['infancia', 'infancy, childhood'],
    ['habilidad', 'ability, skill, talent'],
    ['misterio', 'mystery'],
    ['japonés', 'Japanese'],
    ...
    ['primario', 'primary'],
    ['efectuar', 'to carry out, cause to happen'],
    ...
    ['carecer', 'to be without'],
    ['crimen', 'crime, murder'],
    ['liberal', 'liberal'],
    ['canto', 'singing, chant'],
    ['disponible', 'available'],
    ['coronel', 'colonel'],
    ['invadir', 'to invade, overcome'],
    ['oponer', 'to oppose'],
    ['deportivo', 'sports, sporty'],
    ['caballero', 'gentleman, knight'],
    ['sabio', 'wise, learned'],
    ['laboratorio', 'laboratory'],
    ['oriental', 'Eastern, oriental'],
    ['músico', 'musician'],
    ['ampliar', 'to enlarge, increase, expand'],
    ['dama', 'lady, dame'],
    ['material', 'material'],
    ['ciego', 'blind'],
    ['oficio', 'job, occupation, function'],
    ['frecuente', 'frequent'],
    ...
    ['rendir', '[se] to give in; to render'],
    ['alternativa', 'alternative'],
    ['claramente', 'clearly'],
    ['renunciar', 'to give up, renounce'],
    ['anuncio', 'advertisement, announcement'],
    ['encuesta', 'poll, survey, inquiry'],
    ['admirar', 'to admire'],
    ['disparar', 'to shoot (at)'],
    ['múltiple', 'multiple, many'],
    ['alegre', 'happy, lively, cheerful'],
    ['piano', 'piano'],
    ...
    ['preparación', 'preparation, training'],
    ['aceite', 'oil'],
    ['árabe', 'Arab'],
    ['distrito', 'district, area'],
    ['Internet', 'Internet'],
    ['cantante', 'singer'],
    ['patria', 'native land, fatherland'],
    ['león', 'lion'],
    ['sabor', 'taste, flavor, sensation'],
    ['derivar', 'to derive, come (from)'],
    ['definitivamente', 'definitely, finally'],
    ...
    ['brillar', 'to shine, twinkle, be outstanding'],
    ['milagro', 'miracle'],
    ['académico', 'academic'],
    ...
    ['torre', 'tower'],
    ['tabla', 'chart, board, table, plank'],
    ['perfil', 'profile, outline'],
    ['práctico', 'practical, skillful'],
    ['disciplina', 'discipline, subject'],
    ['móvil', 'mobile'],
    ['notable', 'outstanding, noteworthy'],
    ['especializado', 'specialized, skilled'],
    ['significado', 'meaning'],
    ['salario', 'salary, wages'],
    ['inicial', 'initial'],
    ['criatura', 'creature, child'],
    ['pista', 'clue, track, trace'],
    ['lago', 'lake'],
    ['digno', 'worthy'],
    ['rumbo', 'direction, course, bearing'],
    ['probable', 'probable'],
    ['cigarrillo', 'cigarette'],
    ['orgullo', 'pride'],
    ['contratar', 'to hire, contract'],
    ['instrucción', 'instruction'],
    ['desempeñar', 'to carry out, fulfill'],
    ['misa', '(religious) Mass'],
    ['repartir', 'to divide, deliver, distribute'],
    ['desconocer', 'to not know, not recognize'],
    ['corrupción', 'corruption'],
    ['barato', 'inexpensive'],
    ['asustar', 'to frighten, scare'],
    ['pesado', 'heavy, boring, tiresome'],
    ['inteligente', 'intelligent'],
    ['padecer', 'to suffer'],
    ['mezcla', 'mixture, blend'],
    ['penetrar', 'to penetrate, come in'],
    ['inspirar', 'to inspire, inhale'],
    ['adaptar', 'to adapt'],
    ['colectivo', 'collective, joint'],
    ['agitar', 'to shake, move'],
    ['evidencia', 'evidence, certainty'],
    ['finalizar', 'to end, finalize'],
    ['automóvil', 'automobile'],
    ['venezolano', 'Venezuelan'],
    ['caro', 'expensive, difficult, dear'],
    ['episodio', 'episode, incident'],
    ['cuarto', 'fourth'],
    ['recientemente', 'recently'],
    ['rasgo', 'feature, trait'],
    ['latinoamericano', 'Latin American'],
    ['rezar', 'to pray, recite'],
    ['concurso', 'competition, gathering'],
    ['deber', 'duty, obligation'],
    ['elevado', 'elevated, high, lofty'],
    ['odiar', 'to hate'],
    ['calificar', 'to grade, rate, qualify'],
    ['especialista', 'specialist'],
    ['gobernador', 'governor'],
    ['escritura', 'writing, scripture'],
    ['concentración', 'concentration, gathering'],
    ['promesa', 'promise'],
    ['centrar', 'to center, focus, base (on)'],
    ['detectar', 'to detect'],
    ['cultivar', 'to cultivate, produce'],
    ['fortuna', 'fortune, fate'],
    ['productor', 'producer'],
    ['adivinar', 'to guess, solve'],
    ['vosotros', 'you (subj-pl/+fam)'],
    ['síntoma', 'symptom'],
    ['vital', 'vital, lively, essential'],
    ['transcurrir', 'to occur, take place'],
    ['habitar', 'to inhabit'],
    ['rumor', 'rumor, murmur'],
    ...
    ['emprender', 'to undertake, embark on'],
    ['consulta', 'consultation, advice'],
    ['cinta', 'tape, ribbon, film, strip'],
    ['posiblemente', 'possibly'],
    ['creencia', 'belief'],
    ['turno', 'turn, shift; en t. a: around'],
    ['tráfico', 'traffic, trade'],
    ['compuesto', 'composite, mixed'],
    ['sacudir', 'to shake, jolt'],
    ['protesta', 'objection, protest'],
    ['abrazo', 'hug, embrace'],
    ['igualmente', 'equally'],
    ['desgracia', 'misfortune, bad luck'],
    ['funcionamiento', 'functioning, operation'],
    ['palo', 'stick, pole'],
    ['aéreo', 'aerial, air'],
    ['fundamentalmente', 'fundamentally, basically'],
    ['cómodo', 'comfortable, convenient'],
    ['reproducir', 'to reproduce, repeat'],
    ['secar', 'to dry'],
    ['lujo', 'luxury'],
    ['delgado', 'thin, skinny'],
    ['héroe', 'hero'],
    ...
    ['fiscal', 'fiscal, treasury'],
    ['vela', 'candle, sail, vigil'],
    ['testimonio', 'testimony, evidence'],
    ['estrecho', 'narrow'],
    ['proteína', 'protein'],
    ['locura', 'madness, insanity'],
    ['alegrar', 'to be/make happy'],
    ['sillón', 'armchair, seat'],
    ['tesis', 'thesis, exposition'],
    ['íntimo', 'close, intimate'],
    ['presidencial', 'presidential'],
    ['adolescente', 'adolescent'],
    ['talento', 'talent, skill'],
    ['extensión', 'extension, area, expanse'],
    ['distribuir', 'to distribute, deliver'],
    ...
    ['claridad', 'clearness, clarity'],
    ['izquierdo', 'left (opposite of right)'],
    ['fórmula', 'formula'],
    ['pelota', 'ball'],
    ['existente', 'existing'],
    ['precisar', 'to do exactly, specify'],
    ['solucionar', 'to solve, settle'],
    ['alrededor', 'about, around, round'],
    ['componente', 'component, ingredient'],
    ['dormitorio', 'bedroom, dormitory'],
    ['denuncia', 'accusation'],
    ['fábrica', 'factory, manufacture'],
    ['respectivo', 'respective'],
    ['toro', 'bull'],
    ['prolongar', 'to extend, prolong'],
    ['delicado', 'delicate'],
    ['cerveza', 'beer, ale'],
    ['reaccionar', 'to react'],
    ['estómago', 'stomach'],
    ...
    ['academia', 'academy'],
    ['vientre', 'womb, belly'],
    ['apariencia', 'appearance, aspect'],
    ['alcohol', 'alcohol'],
    ['sacrificio', 'sacrifice'],
    ['danza', 'dance'],
    ['compositor', 'composer'],
    ['concepción', 'conception'],
    ['seno', 'breast, bosom, cavity'],
    ['terror', 'terror, horror'],
    ['bomba', 'bomb, explosion, pump'],
    ['seguro', 'insurance'],
    ['arquitecto', 'architect'],
    ['entusiasmo', 'enthusiasm'],
    ['desprender', 'to detach, release, remove'],
    ['murmurar', 'to murmur, whisper, mutter'],
    ['adiós', 'goodbye'],
    ['armado', 'armed'],
    ['colaboración', 'collaboration'],
    ['exceso', 'excess'],
    ['liga', 'league, elastic band'],
    ['mapa', 'map'],
    ['ceremonia', 'ceremony'],
    ...
    ['ejecutivo', 'executive'],
    ['limitado', 'limited'],
    ['postura', 'posture, position, attitude'],
    ['presidencia', 'presidency'],
    ['conservador', 'conservative'],
    ['proyectar', 'to project'],
    ['paquete', 'package, packet'],
    ['margen', 'edge, margin, border, brink'],
    ['camión', 'truck, van, tanker'],
    ['creciente', 'growing, increasing'],
    ['guía', 'guide, leader'],
    ['galería', 'gallery, balcony'],
    ['conexión', 'connection, relationship'],
    ['agotar', 'to exhaust, wear out, run out'],
    ['prender', 'to turn on, apprehend'],
    ['dispositivo', 'device, mechanism'],
    ['organizado', 'organized'],
    ['verso', 'verse, poem'],
    ['bañar', 'to bathe, take a bath'],
    ['abarcar', 'to encompass, comprise'],
    ['fantasía', 'fantasy, fancy'],
    ['establecimiento', 'establishment'],
    ['complicado', 'complicated, complex'],
    ['mueble', '(piece of) furniture'],
    ['dieta', 'diet'],
    ['trato', 'treatment, manner, agreement'],
    ['leyenda', 'legend'],
    ['borracho', 'drunk'],
    ...
    ['corregir', 'to correct, rectify'],
    ['suspender', 'to suspend, hang, fail'],
    ['media', 'average; a m.: halfways'],
    ['legislativo', 'legislative'],
    ['fallar', 'to fail, miss'],
    ['intensidad', 'intensity, force'],
    ['paciencia', 'patience'],
    ['derrota', 'defeat, loss'],
    ...
    ['pálido', 'pale, ghastly, faded'],
    ['oculto', 'hidden, occult'],
    ['tonto', 'stupid, dumb'],
    ['transformación', 'transformation'],
    ['circular', 'to circulate, go around, flow'],
    ['satisfacer', 'to satisfy'],
    ['provenir', 'to come from, be from'],
    ['lógico', 'logical'],
    ...
    ['nocturno', 'nocturnal, evening'],
    ['enlace', 'link, connection, bond'],
    ['mierda', 'shit, crap, excrement'],
    ['catorce', 'fourteen'],
    ...
    ['oeste', 'west'],
    ['obedecer', 'to obey'],
    ['sentencia', '(legal) sentence, judgment'],
    ['acomodar', 'to be/make comfortable'],
    ['sólido', 'solid, strong'],
    ['sobrar', 'to be too much, left over'],
    ['guiar', 'to guide, lead, steer'],
    ['nave', 'spacecraft, ship'],
    ['interesado', '(self-) interested'],
    ['ola', 'wave, billow'],
    ['porcentaje', 'percentage'],
    ['localizar', 'to locate, find, localize'],
    ['visitante', 'visitor'],
    ['explotar', 'to explode, exploit'],
    ['sueldo', 'salary, pay'],
    ['eficaz', 'effective'],
    ['descanso', 'rest, interval, break'],
    ['expulsar', 'to expel, throw out'],
    ['hábito', 'habit'],
    ['euro', 'euro'],
    ['avisar', 'to inform, announce'],
    ['pasaje', 'fare, passage, lane'],
    ['espectador', 'spectator, onlooker'],
    ['promoción', 'promotion'],
    ['costado', 'side, flank'],
    ['doctrina', 'doctrine, teachings'],
    ...
    ['sospechar', 'to suspect, suppose'],
    ['comparación', 'comparison'],
    ['noventa', 'ninety'],
    ['cesar', 'to cease, stop'],
    ['eco', 'echo, response'],
    ['escolar', 'school, scholastic'],
    ['parlamento', 'parliament, dialogue'],
    ['regular', 'to regulate, adjust'],
    ['divertido', 'funny, amusing'],
    ['desierto', 'desert'],
    ['novedad', 'latest news, newness'],
    ['incremento', 'increase, raise'],
    ['foro', 'forum'],
    ['redondo', 'round'],
    ['castigo', 'punishment, penalty'],
    ['abordar', 'to board, get in/on'],
    ['boda', 'marriage, wedding'],
    ['castigar', 'to punish'],
    ['prisa', 'hurry'],
    ['civilización', 'civilization'],
    ['tragar', 'to swallow'],
    ['depósito', 'deposit, sediment'],
    ['basura', 'garbage, rubbish'],
    ['escándalo', 'scandal'],
    ['tranquilidad', 'tranquility, peace'],
    ['conveniencia', 'convenience, usefulness'],
    ['genético', 'genetic'],
    ...
    ['vegetal', 'plant, vegetable'],
    ['lamentar', 'to regret'],
    ['desplazar', 'to replace, move, shift'],
    ['beneficiar', 'to benefit'],
    ['complicar', 'to complicate, make difficult'],
    ['marino', 'marine, naval'],
    ['rabia', 'rage'],
    ['fantástico', 'fantastic, unreal'],
    ['escultura', 'sculpture, carving'],
    ['manejo', 'handling, management'],
    ['combate', 'combat, battle, fight'],
    ['incapaz', 'incapable'],
    ['difundir', 'to spread (out)'],
    ['tumba', 'tomb, grave'],
    ['exclusivo', 'exclusive'],
    ['multitud', 'multitude'],
    ['aspirar', 'to aspire, want'],
    ...
    ['copia', 'copy'],
    ['agudo', 'sharp, acute'],
    ['violar', 'to violate, trespass, rape'],
    ...
    ['depositar', 'to deposit, place, store'],
    ['conquista', 'conquest'],
    ['flotar', 'to float, flutter'],
    ['exclusivamente', 'exclusively'],
    ['parecer', 'opinion, looks'],
    ['despierto', 'awake'],
    ['reto', 'challenge, defiance'],
    ['ridículo', 'ridiculous, absurd'],
    ['desastre', 'disaster'],
    ['utilización', 'use, utilization'],
    ['requisito', 'prerequisite, requirement'],
    ['originar', 'to give rise (to), cause'],
    ['encabezar', 'to head, lead (off)'],
    ['optar', 'to choose, opt for'],
    ['extenso', 'extensive, large'],
    ['gen', 'gene'],
    ['índice', 'index, forefinger'],
    ['dorado', 'golden, gold-plated'],
    ['cena', 'dinner'],
    ['consideración', 'consideration, regard'],
    ['plataforma', 'platform, springboard'],
    ['castillo', 'castle'],
    ['semilla', 'seed'],
    ['rural', 'rural, country'],
    ...
    ['estadio', 'stadium'],
    ['oriente', 'East'],
    ['auxiliar', 'aide, auxiliary'],
    ['filósofo', 'philosopher'],
    ['cansar', 'to tire, annoy'],
    ['torneo', 'tournament'],
    ['sufrimiento', 'suffering'],
    ['eje', 'axis, shaft, crux'],
    ['captar', 'to capture, attract'],
    ['vincular', 'to conenct, link, bind'],
    ['amanecer', 'daybreak, dawn'],
    ['preso', 'prisoner'],
    ['inaugurar', 'to inaugurate, start'],
    ['descargar', 'to unleash, unload'],
    ['remedio', 'alternative, cure, solution'],
    ['estúpido', 'stupid, idiotic'],
    ['comprensión', 'understanding'],
    ['bienestar', 'well-being, welfare'],
    ['comedor', 'dining room'],
    ['humedad', 'humidity'],
    ['realización', 'fulfillment, realization'],
    ['reflejo', 'reflection'],
    ['jaja', 'ha ha'],
    ...
    ['noble', 'noble'],
    ['maldecir', 'to curse, insult'],
    ['constar', 'to consist of, comprise'],
    ['grasa', 'grease, fat'],
    ['forzar', 'to force'],
    ['estancia', 'stay, stance, ranch'],
    ['prisión', 'prison, imprisonment'],
    ['sábana', '(bed) sheet'],
    ['asesinato', 'murder, assassination'],
    ['protestar', 'to protest, object'],
    ['criar', 'to bring up, rear'],
    ['fama', 'reputation, fame'],
    ['especializar', 'to specialize, major in'],
    ['ordenador', 'computer'],
    ['mito', 'myth'],
    ['expansión', 'expansion, spreading'],
    ['metálico', 'metallic'],
    ['lástima', 'shame, pity'],
    ['logro', 'success, achievement'],
    ['horror', 'horror, atrocity'],
    ['deshacer', 'to undo, destroy, take apart'],
    ['derrotar', 'to defeat, beat'],
    ['lógica', 'logic'],
    ['colega', 'colleague'],
    ['aislado', 'isolated'],
    ...
    ['recorrido', 'journey, itinerary, route'],
    ['vacaciones', 'vacation'],
    ['mandato', 'mandate, order, command'],
    ...
    ['expectativa', 'expectation, hope, prospect'],
    ['homenaje', 'homage, tribute'],
    ['gratuito', 'free, arbitrary, gratuitous'],
    ['policial', 'police'],
    ['ejecución', 'performance, execution'],
    ['entrabar', 'to obstruct'],
    ['barra', 'bar, rod, rail'],
    ['designar', 'to designate'],
    ['aparentemente', 'apparently'],
    ['pico', 'y p.: and a bit; beak, peak'],
    ['tormenta', 'storm'],
    ['herencia', 'inheritance, legacy'],
    ['ejecutivo', 'executive, manager'],
    ['picar', 'to bite, sting, itch'],
    ['estimular', 'to stimulate, encourage'],
    ['mortal', 'mortal, lethal, deadly'],
    ...
    ['joder', 'to f**k, screw (around/up)'],
    ['agujero', 'hole, opening'],
    ['masivo', 'mass, massive'],
    ['anotar', 'to annotate, jot, note'],
    ['doloroso', 'painful'],
    ...
    ['músculo', 'muscle'],
    ['dependencia', 'dependence, dependency'],
    ['rendimiento', 'yield, output, efficiency'],
    ['cuadra', '(city) block'],
    ['recomendación', 'recommendation'],
    ['impresionante', 'impressive, astonishing'],
    ['medicamento', 'medicine, drug'],
    ['asistencia', 'attendance, assistance'],
    ['rogar', 'to implore, pray, ask'],
    ['fiebre', 'fever, excitement'],
    ['aproximar', 'to come near, closer'],
    ['respiración', 'respiration, breath'],
    ['explotación', 'exploitation, cultivation'],
    ['despacho', 'office, study'],
    ['clasificar', 'to classify, sort, file'],
    ['dieciocho', 'eighteen'],
    ['emocional', 'emotional'],
    ['voluntario', 'voluntary, volunteer'],
    ['brasileño', 'Brazilian'],
    ['enfrentamiento', 'confrontation'],
    ['primavera', 'spring, springlike'],
    ['imprimir', 'to print'],
    ['cintura', 'waist'],
    ...
    ['mediado', 'mid, middle'],
    ['elegante', 'elegant, smart, stylish'],
    ['falda', 'skirt'],
    ['defensor', 'defender'],
    ['sensible', 'sensitive, sentient'],
    ['ansiedad', 'anxiety'],
    ['operativo', 'operative, operational'],
    ['competir', 'to compete'],
    ['proclamar', 'to proclaim'],
    ['orgánico', 'organic'],
    ['excesivo', 'excessive'],
    ['motivar', 'to motivate, cause'],
    ['infierno', 'hell, inferno'],
    ['excepto', 'except (for)'],
    ['infección', 'infection'],
    ['ciudadanía', 'citizenship, citizens'],
    ['intercambio', 'exchange, interchange'],
    ['poético', 'poetic'],
    ['barba', 'beard'],
    ['hueco', 'hole, cavity'],
    ['modificación', 'modification, alteration'],
    ['cooperación', 'cooperation'],
    ['resaltar', 'to emphasize'],
    ['aconsejar', 'to advise, counsel'],
    ['patrimonio', 'patrimony, inheritance'],
    ['tapar', 'to cover, wrap'],
    ['masculino', 'masculine, manly, male'],
    ['selva', 'forest, jungle'],
    ['asociado', 'associated'],
    ['esquema', 'outline, diagram, plan'],
    ...
    ['especialidad', 'specialty, specialized field'],
    ['musulmán', 'Moslem, Muslim'],
    ['ahogar', 'to drown, choke, flood'],
    ['totalidad', 'whole, totality'],
    ['abundante', 'abundant, plentiful'],
    ['infraestructura', 'infrastructure'],
    ['administrar', 'to administer, manage'],
    ['bebida', 'drink, beverage'],
    ['enfoque', 'focus, approach'],
    ['sensibilidad', 'sensitivity'],
    ['revés', 'al r.: backwards, upside down, inside out'],
    ['cumplimiento', 'fulfillment, compliment'],
    ['particularmente', 'particularly, personally'],
    ['feria', 'fair, festival'],
    ['avanzado', 'advanced'],
    ['evolucionar', 'to evolve, develop'],
    ['uniforme', 'uniform'],
    ['brillo', 'shine, twinkling, sparkle'],
    ['limitación', 'limitation'],
    ['decreto', 'decree, order'],
    ['vigilar', 'to watch over, guard'],
    ['reducido', 'reduced, limited'],
    ['ternura', 'tenderness'],
    ['fortalecer', 'to fortify'],
    ['lesión', 'injury, wound, harm'],
    ['trozo', 'piece, chunk'],
    ['imitar', 'to imitate, copy, mimic'],
    ['desesperación', 'desperation, exasperation'],
    ['tabaco', 'tobacco, cigarette, cigar'],
    ['ejemplar', 'copy, issue'],
    ['culto', 'worship, cult'],
    ['petición', 'request, petition'],
    ['exhibir', 'to exhibit, show off'],
    ['morder', 'to bite'],
    ...
    ['barro', 'clay, mud'],
    ['culpable', 'guilty'],
    ['comandante', 'commander, commanding officer'],
    ['definido', 'definite'],
    ['variable', 'variable, changeable'],
    ['noticias', 'news'],
    ['absorber', 'to absorb, soak up'],
    ['porqué', 'reason, cause'],
    ['multiplicar', 'to multiply'],
    ['pendiente', 'slope, descent, earring'],
    ['coalición', 'coalition'],
    ['copiar', 'to copy'],
    ['caña', 'cane, reed'],
    ['presa', 'dam, prisoner (f)'],
    ['desafío', 'challenge, provocation'],
    ['encendido', 'turned on, burning'],
    ['seda', 'silk'],
    ['consenso', 'consensus, consent'],
    ['obispo', 'bishop'],
    ['localidad', 'town, locality'],
    ['chocar', 'to crash into, collide with'],
    ['radical', 'radical'],
    ['ligar', 'to tie, link, bind'],
    ['sonoro', 'loud, resounding'],
    ['exigencia', 'requirement, demand'],
    ['variación', 'variation'],
    ['cierre', 'zipper, closing'],
    ['últimamente', 'lately, recently'],
    ['conveniente', 'convenient'],
    ['don', 'courtesy title (m), Mr., gift'],
    ['pasajero', 'passenger'],
    ['nervio', 'nerve'],
    ...
    ['severo', 'severe'],
    ['difusión', 'spread, diffusion'],
    ['subrayar', 'to underline, highlight, emphasize'],
    ['arroz', 'rice'],
    ['emisión', 'broadcast, emission'],
    ['criminal', 'criminal'],
    ['flujo', 'flow, tide, discharge'],
    ['calmar', 'to calm, soothe, relieve'],
    ['almuerzo', 'lunch'],
    ['transmisión', 'broadcast, transmission'],
    ['titular', 'to title, call'],
    ['genial', 'brilliant, inspired'],
    ['estirar', 'to stretch, strain'],
    ['afirmación', 'statement, assertion'],
    ['cualidad', 'quality, attribute'],
    ...
    ['penal', 'penal'],
    ['esclavo', 'slave'],
    ['negociar', 'to negotiate, deal (with/in)'],
    ['aroma', 'aroma'],
    ['proseguir', 'to continue, carry on'],
    ['remoto', 'remote, far-off'],
    ...
    ['programar', 'to plan, program'],
    ['corriente', 'current, common'],
    ['sobrino', 'nephew'],
    ['residir', 'to reside, live (in)'],
    ['carcajada', 'hearty laughter, guffaw'],
    ['convocatoria', 'call, summons'],
    ['naranja', 'orange (fruit)'],
    ['pozo', 'well, shaft'],
    ['debilidad', 'weakness'],
    ['rescatar', 'to rescue, save'],
    ['aviso', 'warning'],
    ['ocupación', 'occupation, use'],
    ['cruel', 'cruel, harsh'],
    ['certeza', 'certainty'],
    ['ácido', 'acid'],
    ['detallar', 'to detail, itemize'],
    ['kilo', 'kilogram'],
    ['leve', 'slight, trifling, light'],
    ['cumbre', 'summit, top'],
    ['licencia', 'license, permission'],
    ['asociar', 'to associate with'],
    ...
    ['convenio', 'agreement'],
    ['olvido', 'forgetfulness, omission'],
    ['cajón', 'drawer'],
    ['amo', 'master, boss (m)'],
    ['cementerio', 'cemetery, graveyard'],
    ['obviamente', 'obviously'],
    ['portar', 'to behave [se], carry'],
    ['integral', 'comprehensive, integral, built-in'],
    ['chiste', 'joke, funny story'],
    ['ruina', 'ruin, collapse'],
    ['empresarial', 'managerial'],
    ['molécula', 'molecule'],
    ['editar', 'to edit, publish, release'],
    ['confusión', 'confusion'],
    ['ayuntamiento', 'city council, town hall'],
    ['genio', 'genius, disposition'],
    ['colonial', 'colonial'],
    ['terrestre', 'earthly, of the earth'],
    ...
    ['pesadilla', 'nightmare'],
    ['toque', 'touch, ringing, warning'],
    ['agenda', 'diary, agenda, schedule'],
    ['rechazo', 'rejection, refusal'],
    ['mérito', 'worth, merit'],
    ['solidaridad', 'solidarity, togetherness'],
    ['billete', 'ticket, bill, note'],
    ...
    ['mantenimiento', 'maintenance, sustenance'],
    ...
    ['insecto', 'insect'],
    ['continuación', 'continuation, follow-up'],
    ['equivalente', 'equivalent'],
    ['dotar', 'to endow, bestow'],
    ['arder', 'to burn, glow'],
    ['atento', 'attentive, polite'],
    ['filosófico', 'philosophical'],
    ['monetario', 'monetary,'],
    ['saco', 'sack, bag, plunder'],
    ['invisible', 'invisible'],
    ['estatua', 'statue'],
    ['vapor', 'vapor, steam'],
    ['capturar', 'to capture'],
    ['cálido', 'warm'],
    ['favorable', 'favorable, suitable'],
    ['bronce', 'bronze'],
    ['turístico', 'tourist'],
    ['ahorita', 'right now, in a minute'],
    ['helado', 'iced, freezing, icy'],
    ['gallo', 'rooster'],
    ['desagradable', 'unpleasant'],
    ['suficientemente', 'enough'],
    ['resumir', 'to summarize'],
    ['préstamo', 'loan, borrowing'],
    ['quieto', 'still, motionless, calm'],
    ['tubo', 'tube, pipe'],
    ['librar', 'to liberate, set free'],
    ['considerable', 'considerable'],
    ['cuadrado', 'square'],
    ['precisión', 'precision'],
    ['trámite', 'procedure, step, requirement'],
    ['pastor', 'shepherd, pastor'],
    ['acero', 'steel'],
    ['comedia', 'comedy, play, pretense'],
    ['pendiente', 'aware of, pending'],
    ['fibra', 'fiber, grain'],
    ['juvenil', 'young, juvenile'],
    ['obvio', 'obvious'],
    ['fiscal', 'district attorney, prosecutor'],
    ['trampa', 'trick, trap; hacer t.: to cheat'],
    ...
    ['pausa', 'pause'],
    ['cartera', 'wallet, satchel'],
    ['pañuelo', 'handkerchief, shawl'],
    ['estratégico', 'strategic'],
    ['taza', 'cup, bowl'],
    ['reventar', 'to burst, puncture'],
    ['reservar', 'to reserve, book'],
    ['relatar', 'to tell, narrate'],
    ...
    ['estupendo', 'marvelous, stupendous'],
    ['pacífico', 'peaceful'],
    ['entrenamiento', 'training'],
    ['frenar', 'to brake, restrain'],
    ['prevenir', 'to avoid, prevent'],
    ['complejo', 'complex'],
    ['conservación', 'conservation'],
    ['antigüedad', 'antiquity, seniority'],
    ['cuota', 'quota, share, dues'],
    ...
    ['magia', 'magic'],
    ['prima', 'female cousin, down payment'],
    ['adorar', 'to worship, adore'],
    ['afán', 'eagerness, zeal, effort'],
    ['casco', 'helmet'],
    ...
    ['editorial', 'publisher (f), editorial article (m)'],
    ['taxi', 'taxi, cab'],
    ['saber', 'knowledge'],
    ['banca', 'bank, banking'],
    ['transición', 'transition'],
    ['asombrar', 'to amaze, astound'],
    ['tonelada', 'ton'],
    ['lingüístico', 'linguistic'],
    ['quebrar', 'to break, bend, weaken'],
    ['válido', 'valid'],
    ['invasión', 'invasion'],
    ['descartar', 'to discard, reject, rule out'],
    ['contaminación', 'contamination, pollution'],
    ['aplastar', 'to flatten, crush, smash'],
    ['amanecer', 'to dawn, become light'],
    ...
    ['plano', 'flat, plain, even, level'],
    ['decisivo', 'decisive, conclusive'],
    ['gallina', 'hen, coward'],
    ['confuso', 'confused, mixed up'],
    ['estricto', 'strict, rigorous'],
    ...
    ['circuito', 'circuit, circumference, track'],
    ...
    ['carbono', 'carbon, coal'],
    ['franco', 'open, frank, outspoken'],
    ['paloma', 'dove'],
    ['sacrificar', 'to sacrifice'],
    ['casualidad', 'chance, coincidence'],
    ['aquél', 'that one over there (m)'],
    ['planear', 'to plan'],
    ['queso', 'cheese'],
    ...
    ['festival', 'festival'],
    ['contraste', 'contrast'],
    ['intimidad', 'private life, intimacy'],
    ['inspiración', 'inspiration, inhalation'],
    ['cancha', 'playing field, court'],
    ['latín', 'Latin'],
    ['relevante', 'relevant, significant'],
    ['miel', 'honey'],
    ['crónica', 'account, chronicle'],
    ['armonía', 'harmony'],
    ['colectivo', 'collective, group'],
    ['encanto', 'charm, spell'],
    ['aliviar', 'to lighten, relieve, comfort'],
    ['trastorno', 'confusion, trouble, upheaval'],
    ['fallo', 'mistake, blunder, fault'],
    ['ceniza', 'ash'],
    ['gráfico', 'graphic, explicit'],
    ['colaborador', 'collaborator'],
    ['demandar', 'to claim, sue'],
    ['contraer', 'to contract, shrink, abbreviate'],
    ['manzana', 'apple, (city) block'],
    ['portugués', 'Portuguese'],
    ['elemental', 'elemental, basic'],
    ['tropical', 'tropical'],
    ['eficacia', 'efficiency, effectiveness'],
    ['revisión', 'checking revision'],
    ...
    ['explorar', 'to explore'],
    ['diversidad', 'diversity, variety'],
    ['rosario', 'rosary, beads, string'],
    ['bancario', 'bank, banking'],
    ['indispensable', 'indispensable, essential'],
    ['proyección', 'projection, screening'],
    ['institucional', 'institutional'],
    ['enriquecer', 'to enrich'],
    ['geográfico', 'geographical'],
    ['curva', 'curve'],
    ['acento', 'accent, stress'],
    ['ocasionar', 'to occasion, bring about'],
    ['sanción', 'sanction, approval, penalty'],
    ['tribu', 'tribe'],
    ['herir', 'to wound, hurt'],
    ['perfección', 'perfection'],
    ['gigantesco', 'giant, gigantic'],
    ['giro', 'turn, draft, expression'],
    ['ira', 'rage, wrath'],
    ...
    ['fracasar', 'to fail, be unsuccessful'],
    ...
    ['seminario', 'seminar, seminary'],
    ['disputar', 'to dispute, contest'],
    ['visual', 'visual'],
    ['instinto', 'instinct'],
    ['reiterar', 'to reiterate, repeat'],
    ['licenciado', 'graduate, lawyer'],
    ['rapidez', 'speed, velocity'],
    ['recinto', 'grounds, precincts'],
    ['admiración', 'admiration'],
    ['acusación', 'accusation, charge'],
    ['editor', 'editor, publisher'],
    ['fundador', 'founder'],
    ['mediano', 'average, medium, ordinary'],
    ...
    ['trago', 'swig, drink'],
    ['radiación', 'radiation'],
    ['aportación', 'contribution, support'],
    ['fortaleza', 'fortress, strength'],
    ['resumen', 'summary'],
    ['teatral', 'theatrical'],
    ['posar', 'to rest, pose, land'],
    ['cuaderno', 'notebook, workbook'],
    ['piloto', 'pilot, driver'],
    ['oral', 'oral'],
    ['moreno', 'dark, brown'],
    ['furia', 'fury, rage'],
    ...
    ['dinastía', 'dynasty'],
    ['entrever', 'to glimpse, guess'],
    ['liderazgo', 'leadership'],
    ['occidente', 'West'],
    ['tontería', 'stupidity, stupid thing'],
    ['sello', 'stamp, seal'],
    ['consolidar', 'to consolidate'],
    ['energético', 'energetic'],
    ['déficit', 'deficit, shortage'],
    ['trapo', 'rag, cloth'],
    ['concretamente', 'specifically, exactly'],
    ['senado', 'senate'],
    ['argumentar', 'to argue, deduce'],
    ['quinientos', 'five hundred'],
    ['colgado', 'hanging'],
    ['bachillerato', 'academic degree'],
    ['clínico', 'clinical'],
    ['medieval', 'medieval'],
    ['iluminado', 'illuminated'],
    ['respaldo', 'support, backing, back'],
    ['entrenador', 'coach, trainer, manager'],
    ['rango', 'rank, range'],
    ['sanitario', 'health, sanitary, clean'],
    ['carbón', 'coal, charcoal'],
    ['heredar', 'to inherit'],
    ['portal', 'website, portal, entrance'],
    ['sospecha', 'suspicion'],
    ['diplomático', 'diplomatic'],
    ['trazar', 'to draw, trace'],
    ['mozo', 'waiter, youth, bellboy'],
    ['entusiasmar', 'to fill with enthusiasm, excite'],
    ['polémica', 'polemics, argument'],
    ['máscara', 'mask'],
    ['persecución', 'pursuit, persecution'],
    ['aceptación', 'acceptance, approval'],
    ['adornar', 'to adorn, to decorate'],
    ['aficionado', 'fan, devotee'],
    ['desviar', 'to deviate, divert, change'],
    ['aliado', 'ally'],
    ['esfera', 'sphere, globe'],
    ['presionar', 'to press, pressure'],
    ['simpático', 'nice, likeable, friendly'],
    ['comerciante', 'merchant, businessperson'],
    ['candidatura', 'candidacy'],
    ['ratificar', 'to ratify'],
    ['turco', 'Turkish'],
    ['chiquito', 'tiny'],
    ['electricidad', 'electricity'],
    ['culminar', 'to culminate, accomplish'],
    ['felicitar', 'to congratulate'],
    ['autorizar', 'to authorize, legalize'],
    ['mariposa', 'butterfly, wing nut'],
    ['síntesis', 'synthesis'],
    ['concesión', 'awarding, concession'],
    ...
    ['mojado', 'wet'],
    ['disimular', 'to disguise, hide, pretend'],
    ['laguna', 'lagoon'],
    ...
    ['ronda', 'round'],
    ['enfermero', 'nurse'],
    ['generalizar', 'to generalize, popularize'],
    ['preferencia', 'preference'],
    ['delicioso', 'delicious, delightful, charming'],
    ['soberanía', 'sovereignty'],
    ['enojar', 'to anger, annoy'],
    ['aparente', 'apparent'],
    ['anónimo', 'anonymous'],
    ['melodía', 'melody'],
    ['variado', 'varied, mixed'],
    ['prisionero', 'prisoner'],
    ['lazo', 'bow, knot, tie, lasso'],
    ['tierno', 'tender, soft'],
    ['blando', 'soft, limp, gentle'],
    ['convencional', 'conventional'],
    ['ingresos', 'income, revenue'],
    ['pretexto', 'pretext, excuse'],
    ['fatal', 'fateful, deadly, awful'],
    ['sujetar', 'to fasten, attach, hold'],
    ...
    ['molesto', 'annoyed, bothered, upset'],
    ['cobre', 'copper'],
    ['hondo', 'deep'],
    ['rígido', 'rigid, stiff, firm'],
    ['desayuno', 'breakfast'],
    ['paro', 'labor strike, attack'],
    ['injusto', 'unfair, unjust'],
    ['lanzamiento', 'launch, release'],
    ...
    ['pescado', 'fish'],
    ['dulce', 'candy, sweets'],
    ['soporte', 'support, endorsement'],
    ['fachada', 'façade, front of building'],
    ['ciertamente', 'certainly, indeed'],
    ['asentar', 'to settle, establish, locate'],
    ['automático', 'automatic'],
    ['dañar', 'to damage'],
    ['cuartel', 'quarters, barracks'],
    ['salvaje', 'wild, savage, uncultivated'],
    ['atardecer', 'evening, dusk'],
    ['parcial', 'partial, biased'],
    ['arroyo', 'brook, stream, gutter'],
    ['sendero', '(foot) path'],
    ['abandono', 'abandonment, desertion'],
    ['lamentablemente', 'regrettably'],
    ['simpatía', 'sympathy, affinity'],
    ['holandés', 'Dutch'],
    ['prenda', 'piece of clothing'],
    ['verificar', 'to verify'],
    ['aplauso', 'applause, praise, acclaim'],
    ['espada', 'sword'],
    ['legislador', 'legislator'],
    ['modalidad', 'mode, manner'],
    ['atracción', 'attraction'],
    ['caos', 'chaos'],
    ['queja', 'complaint'],
    ['denso', 'heavy, dense, thick'],
    ...
    ['crudo', 'raw, crude, natural'],
    ['fabricación', 'manufacture, production'],
    ['legítimo', 'legitimate'],
    ['indiferencia', 'indifference'],
    ['almacenar', 'to store, keep'],
    ['decorar', 'to decorate'],
    ['envidia', 'envy'],
    ...
    ['otoño', 'autumn'],
    ['planificación', 'planning, design'],
    ['caricia', 'caress, stroke'],
    ['triunfar', 'to triumph'],
    ['agrupar', 'to (put in) group'],
    ['territorial', 'territorial, regional'],
    ['trágico', 'tragic'],
    ['libra', 'pound (money/weight)'],
    ['ambición', 'ambition'],
    ['navidad', 'Christmas'],
    ['cruce', 'crossing, intersection'],
    ['vicio', 'vice, bad habit, defect'],
    ['escudo', 'shield, coat of arms'],
    ['alternativo', 'alternating, alternative'],
    ['asiático', 'Asian, Asiatic'],
    ['potente', 'potent, powerful'],
    ['inquieto', 'restless, anxious'],
    ['manga', 'sleeve'],
    ['empeñar', '[se] to insist on'],
    ['revelación', 'revelation'],
    ['bahía', 'bay'],
    ['corbata', 'tie, sash'],
    ['azar', 'random, chance, hazard'],
    ['piedad', 'pity, mercy'],
    ['vasto', 'vast, immense, huge'],
    ['virtual', 'virtual, potential'],
    ['fuga', 'flight, escape'],
    ['magnitud', 'magnitude, extent'],
    ['determinación', 'determination'],
    ['mensual', 'monthly'],
    ['regulación', 'adjustment, regulation'],
    ['coordinación', 'coordination'],
    ['ético', 'ethical'],
    ['dueña', 'landlady, owner (f)'],
    ...
    ['desatar', 'to untie, unleash, spark off'],
    ['evangelio', 'gospel'],
    ['narcotráfico', 'drug trafficking'],
    ['choque', 'crash, collision'],
    ['plenamente', 'fully'],
    ['llanura', 'plain, prairie, plainness'],
    ['inscribir', 'to register, record'],
    ['trama', 'plot, theme'],
    ['satélite', 'satellite'],
    ['rastro', 'track, sign, flea market'],
    ['cirugía', 'surgery'],
    ['reportar', 'to bring, report'],
    ['retomar', 'to retake, restart'],
    ['timbre', 'doorbell, bell, seal, stamp'],
    ['asco', 'disgust'],
    ...
    ['redacción', 'editing, wording, essay'],
    ['tejer', 'to sew, weave'],
    ['resbalar', 'to slip'],
    ['inundar', 'to flood, inundate'],
    ['disparo', 'shot, discharge'],
    ['bendición', 'blessing, benediction'],
    ['capacitación', 'training'],
    ['pollo', 'chicken'],
    ['obligado', 'obliged, required'],
    ['pez', '(alive) fish'],
    ['tortura', 'torture'],
    ['párpado', 'eyelid'],
    ['ofender', 'to offend'],
    ['datar', 'to date'],
    ['minoría', 'minority'],
    ['diminuto', 'diminutive, tiny, minute'],
    ['cómplice', 'accomplice'],
    ['continuidad', 'continuity'],
    ['anticipar', 'to anticipate, advance'],
    ['situado', 'situated, located'],
    ['agresión', 'aggression, attack'],
    ['complementar', 'to complement, supplement'],
    ['toma', 'outlet, dose, making'],
    ['énfasis', 'emphasis'],
    ['foco', 'focus'],
    ['cadera', 'hip'],
    ['rata', 'rat'],
    ['desempleo', 'unemployment'],
    ['ademán', 'gesture, expression'],
    ['soplar', 'to blow (wind)'],
    ['exilio', 'exile'],
    ...
    ['átomo', 'atom'],
    ['nadar', 'to swim'],
    ['ecológico', 'ecological, organic'],
    ['relieve', 'relief; poner de r.: to emphasize'],
    ['tímido', 'timid, shy, half-hearted'],
    ['sopa', 'soup'],
    ['ignorancia', 'ignorance'],
    ['sudar', 'to sweat'],
    ['algodón', 'cotton'],
    ['respaldar', 'to back, support, endorse'],
    ['modesto', 'modest, humble'],
    ['prado', 'meadow, field, lawn'],
    ['mercancía', 'goods, merchandise'],
    ['insoportable', 'unbearable, intolerable'],
    ['programación', 'programming, scheduling'],
    ['comunitario', 'of the community'],
    ['asesino', 'killer, assassin'],
    ['insulto', 'insult'],
    ['temblor', 'tremor, shudder, shiver'],
    ['inconveniente', 'inconvenience, drawback'],
    ['vigilancia', 'surveillance, vigilance'],
    ['exagerar', 'to exaggerate'],
    ['circo', 'circus'],
    ['indudablemente', 'doubtless, undoubtedly'],
    ['aludir', 'to allude to'],
    ['vanguardia', 'vanguard, forefront'],
    ['tentación', 'temptation'],
    ['encargado', 'manager, person in charge'],
    ['bacteria', 'germ, bacteria'],
    ['injusticia', 'injustice'],
    ['miserable', 'wretched, miserable'],
    ['materno', 'maternal'],
    ['entrevistar', 'to interview'],
    ['vago', 'vague'],
    ['matiz', 'shade, tint, nuance'],
    ['mármol', 'marble'],
    ['narración', 'narration, account'],
    ['propiamente', 'exactly, properly'],
    ['batería', 'battery, gun deck'],
    ...
    ['corporal', 'of the body, corporal'],
    ['embajada', 'embassy'],
    ['aspiración', 'ambition, aspiration'],
    ['serpiente', 'snake'],
    ['ordenado', 'organized, clean'],
    ['revolver', 'to stir, mix, scramble'],
    ['sinceramente', 'sincerely'],
    ['preceder', 'to precede'],
    ['dramático', 'dramatic'],
    ['repleto', 'full, overcrowded'],
    ['singular', 'single, singular'],
    ...
    ['gira', 'tour'],
    ['librería', 'bookstore'],
    ['fabuloso', 'fabulous, fantastic'],
    ['reclamo', 'claim, complaint, protest'],
    ['gama', 'range, musical scale'],
    ['delincuente', 'delinquent'],
    ['ladrón', 'thief'],
    ['comunicado', 'statement, announcement'],
    ['acentuar', 'to accent, stress'],
    ['fotógrafo', 'photographer'],
    ['bicicleta', 'bicycle'],
    ['lana', 'wool'],
    ['específicamente', 'specifically'],
    ['reparar', 'to repair, restore'],
    ['inscripción', 'inscription, registration'],
    ...
    ['comportar', 'to behave'],
    ['comisario', 'commissioner, delegate'],
    ['consagrar', 'to consecrate, establish'],
    ['incidente', 'incident'],
    ['remontar', 'to go back to (time)'],
    ['monstruo', 'monster, monstrosity'],
    ['ceja', 'eyebrow, brow'],
    ['profeta', 'prophet'],
    ...
    ['seña', 'sign, mark, seal'],
    ['confesión', 'confession, admission'],
    ['capilla', 'chapel'],
    ['autobús', 'bus'],
    ['entrenar', 'to train'],
    ['atar', 'to tie (up)'],
    ['rigor', 'harshness, rigor'],
    ['tolerar', 'to tolerate, put up with'],
    ['asalto', 'assault, robbery'],
    ['complacer', 'to please, satisfy'],
    ['bigote', 'mustache'],
    ['noción', 'notion, idea'],
    ['esforzar', 'to make an effort, exert oneself'],
    ['trono', 'throne'],
    ['cerdo', 'pig, sow, slob'],
    ['frustrar', 'to frustrate, prevent'],
    ['espantar', 'to scare, frighten'],
    ['seguimiento', 'follow-up'],
    ['ritual', 'ritual, rite'],
    ['bondad', 'goodness, kindness'],
    ['espantoso', 'frightening, dreadful'],
    ['autorización', 'authorization'],
    ['vano', 'vain, useless'],
    ['conde', 'count'],
    ['decena', 'ten (of something)'],
    ['profundizar', 'to deepen, analyze in depth'],
    ...
    ['aspirante', 'candidate, applicant'],
    ['coraje', 'courage, toughness'],
    ['problemática', 'problems, difficulties'],
    ['magnético', 'magnetic'],
    ['precipitar', 'to plunge, hurl, rush'],
    ...
    ['gabinete', 'cabinet, den, office'],
    ['balance', 'outcome, balance'],
    ['idéntico', 'identical'],
    ['mojar', 'to make wet, dampen'],
    ['burla', 'mockery, joke, trick'],
    ['finanzas', 'treasury, finances'],
    ['globo', 'balloon, globe'],
    ['inducir', 'to lead to'],
    ['fusión', 'fusion, union'],
    ['convivencia', 'coexistence, living together'],
    ['elaborado', 'thorough, elaborate'],
    ['ardiente', 'passionate, ardent'],
    ['intérprete', 'performer, interpreter'],
    ['exquisito', 'exquisite, superb'],
    ['cobertura', 'coverage'],
    ...
    ['heredero', 'heir, heiress'],
    ['párrafo', 'paragraph'],
    ['delegado', 'delegate, representative'],
    ['rebelión', 'rebellion'],
    ...
    ['aborto', 'abortion'],
    ['tambor', 'drum'],
    ['abrigo', 'overcoat, shelter'],
    ['cigarro', 'cigarette, cigar'],
    ['debatir', 'to debate, discuss'],
    ['ajuste', 'adjustment, settlement'],
    ['acertar', 'to get right'],
    ['patada', 'kick, punt'],
    ['racional', 'rational'],
    ['imperial', 'imperial, imperialist'],
    ['mono', 'monkey'],
    ['planificar', 'to plan'],
    ...
    ['eternidad', 'eternity'],
    ['mentalidad', 'mindset, mind'],
    ['diccionario', 'dictionary'],
    ['dinámica', 'dynamics'],
    ['perla', 'pearl'],
    ['geografía', 'geography'],
    ['emerger', 'to emerge, surface'],
    ['configurar', 'to make up, comprise'],
    ['cordillera', 'mountain range'],
    ['arrugar', 'to wrinkle, crumple'],
    ['hervir', 'to boil'],
    ['bendecir', 'to bless, thank'],
    ['acera', 'sidewalk'],
    ...
    ['voltear', 'to turn over, turn around'],
    ['vigencia', 'validity'],
    ['teniente', 'lieutenant, deputy mayor'],
    ['inconsciente', 'unconscious, thoughtless'],
    ['presunto', 'alleged, presumed'],
    ['contactar', 'to reach, contact'],
    ['pasta', 'pasta, dough'],
    ['tercio', 'third'],
    ['reinar', 'to reign, prevail'],
    ['desempeño', 'performance, achievement'],
    ['portero', 'porter, doorkeeper, goalie'],
    ['improvisar', 'to improvise'],
    ['nacionalidad', 'nationality'],
    ['gracioso', 'funny, charming, amusing'],
    ['resplandor', 'brightness, radiance'],
    ['paja', 'straw, thatching'],
    ['vigor', 'force, strength, vigor'],
    ['pecar', 'to sin'],
    ['decoración', 'decoration'],
    ['verbal', 'verbal, oral'],
    ['repertorio', 'repertoire, list, index'],
    ['disfrazar', 'to disguise, hide, conceal'],
    ['automáticamente', 'automatically'],
    ['restauración', 'restoration, renovation'],
    ['vertical', 'vertical, upright'],
    ['polo', 'pole, polo, polo shirt'],
    ['sucesor', 'successor'],
    ['semestre', 'semester'],
    ['rancho', 'ranch, farm'],
    ...
    ['colmo', 'climax; para c.: to top it all'],
    ...
    ['liderar', 'to lead, head'],
    ['navegación', 'navigation, shipping'],
    ['oscilar', 'oscillate'],
    ['arreglo', 'arrangement'],
    ['intermedio', 'interim, intermediate'],
    ['despreciar', 'to despise, scorn'],
    ['enloquecer', 'to madden, derange'],
    ['prosa', 'prose'],
    ['pauta', 'guideline, rule, standard'],
    ['ensayar', 'to test'],
    ...
    ['extra', 'extra'],
    ['divisar', 'to distinguish, perceive'],
    ['mejora', 'improvement'],
    ['prejuicio', 'prejudice'],
    ['consolar', 'to console'],
    ['adolescencia', 'adolescence'],
    ['órbita', 'orbit, socket, field'],
    ['espléndido', 'splendid, generous'],
    ['mutuo', 'mutual'],
    ['chupar', 'to suck'],
    ['nudo', 'knot'],
    ['sobresalir', 'to stand out, excel'],
    ['sumir', 'to sink, plunge'],
    ['molestia', 'bother, nuisance, trouble'],
    ['resonar', 'to resound, ring, echo'],
    ['trescientos', 'three hundred'],
    ['desprecio', 'contempt, disdain'],
    ['compás', 'rhythm, time, compass'],
    ['trigo', 'wheat'],
    ['transparencia', 'transparency, slide'],
    ['economista', 'economist'],
    ['remediar', 'to heal, cure'],
    ...
    ['expediente', 'dossier, proceedings'],
    ['teñir', 'to dye'],
    ['pretensión', 'pretension, claim, aspiration'],
    ['guerrilla', 'guerrilla'],
    ['recto', 'right, straight, honest'],
    ['bíblico', 'biblical'],
    ['engaño', 'deceit, falsehood, hoax'],
    ...
    ['recepción', 'reception, waiting room'],
    ['oficialmente', 'officially'],
    ['informativo', 'informative'],
    ['manifiesto', 'poner de m.: to show'],
    ['colina', 'hill, slope'],
    ['descendiente', 'descendant'],
    ['manta', 'blanket'],
    ['realista', 'realistic'],
    ['guante', 'glove'],
    ['petrolero', 'oil, petroleum'],
    ['show', 'show, display'],
    ['opositor', 'opponent'],
    ['marítimo', 'maritime, marine'],
    ['raya', 'line, ray, stripe'],
    ['preservar', 'to preserve'],
    ['cañón', 'canyon, cannon'],
    ['capricho', 'caprice, whim'],
    ['nido', 'nest'],
    ['almorzar', 'to have lunch'],
    ['murmullo', 'murmur, whispering'],
    ...
    ['disputa', 'dispute, argument, quarrel'],
    ['costarricense', 'Costa Rican'],
    ['consuelo', 'comfort, consolation'],
    ['graduar', 'to adjust, graduate'],
    ['olímpico', 'Olympic, Olympian'],
    ['química', 'chemistry, chemist'],
    ...
    ['operador', 'operator'],
    ['restaurar', 'to restore, reinstate'],
    ['diariamente', 'daily'],
    ['vibrar', 'to vibrate, tremble'],
    ['coser', 'to sew'],
    ['implementar', 'to implement'],
    ['suicidio', 'suicide'],
    ['sistemático', 'systematic'],
    ['valoración', 'assessment, valuation, evaluation'],
    ['florecer', 'to flower, bloom, flourish'],
    ['ascenso', 'promotion, climb'],
    ['pánico', 'panic'],
    ['talla', 'size (of clothing), stature'],
    ['acta', '(meeting) proceedings, minutes'],
    ['inclinación', 'slope, incline, tendency'],
    ['veinticuatro', 'twenty-four'],
    ['deducir', 'to deduce, infer'],
    ['nene', 'baby, small child'],
    ['reja', 'grill, railing'],
    ['ingrediente', 'ingredient'],
    ['hectárea', 'hectare'],
    ['prestación', 'benefit, lending of service'],
    ['hormona', 'hormone'],
    ['centavo', 'cent'],
    ['idear', 'to devise, design'],
    ['abismo', 'abyss, large gap'],
    ['sanguíneo', 'blood, bloody'],
    ['suministrar', 'to supply, provide'],
    ['islámico', 'Islamic'],
    ['debilitar', 'to weaken, debilitate'],
    ['cristianismo', 'Christianity'],
    ['asignatura', 'subject, course'],
    ['pila', '(baptismal) font, battery, heap'],
    ['ilustración', 'illustration'],
    ['exploración', 'exploration'],
    ['trayecto', 'trajectory, course, path'],
    ['proveedor', 'supplier, dealer'],
    ...
    ['pulso', 'pulse, pulsation'],
    ['competente', 'competent, able'],
    ['usado', 'worn out, old, used'],
    ['vitamina', 'vitamin'],
    ['laberinto', 'maze, labyrinth'],
    ['persistir', 'to persist'],
    ['excelencia', 'excellence'],
    ['malestar', 'discomfort, unease, unrest'],
    ['grandeza', 'greatness, size'],
    ['descarga', 'unloading, discharge'],
    ['mixto', 'mixed, co-ed'],
    ['maleta', 'suitcase, case'],
    ['alegar', 'to plead, argue'],
    ['filtrar', 'to seep, filter'],
    ['traición', 'treason, betrayal'],
    ['medalla', 'medal, medallion'],
    ['ganancia', 'gain, profit'],
    ['equivaler', 'to be equivalent, tantamount (to)'],
    ['reposo', 'rest, peace'],
    ['ayudante', 'helper, assistant'],
    ['porvenir', 'future, time to come'],
    ['aldea', 'small village'],
    ['reinado', 'reign, rule'],
    ['ingenio', 'ingenuity, talent, wit'],
    ['menú', 'menu'],
    ...
    ['nacionalista', 'nationalist, nationalistic'],
    ['agrario', 'agrarian, agricultural'],
    ['electrón', 'electron'],
    ['oscurecer', 'to get dark'],
    ['espectro', 'ghost, specter'],
    ['ente', 'entity, being, firm'],
    ['forestal', 'forest'],
    ['rector', 'principal, rector'],
    ['filo', '(cutting) edge'],
    ['exportar', 'export'],
    ['camiseta', 'T-shirt'],
    ['duelo', 'grief, affliction'],
    ['indicador', 'indicator, gauge'],
    ['fondos', 'funds'],
    ['ironía', 'irony'],
    ['reposar', 'to rest, lie down'],
    ['cartón', 'cardboard, carton, sketch'],
    ['casita', 'cottage'],
    ['crema', 'cream'],
    ...
    ['remover', 'to remove'],
    ['cátedra', 'academic chair'],
    ['comando', 'command, order'],
    ['atentado', '(terrorist) attack, offence'],
    ['ansia', 'anxiety, anguish'],
    ['conllevar', 'to involve, bring'],
    ['peculiar', 'peculiar'],
    ['minero', 'mining'],
    ...
    ['calificación', 'evaluation, qualification'],
    ['transcurso', 'passing, course, lapse'],
    ['resignar', 'to resign, relinquish'],
    ['captura', 'capture, snapshot, screenshot'],
    ['crónico', 'chronic'],
    ['demostración', 'demonstration'],
    ['orar', 'to pray, speak'],
    ['asaltar', 'to assault'],
    ['volcar', 'to turn/knock over, empty'],
    ['moto', 'motorcycle'],
    ['bando', 'faction, side'],
    ['whisky', 'whisky'],
    ['truco', 'trick, ruse'],
    ...
    ['caridad', 'charity'],
    ['gobernación', 'government, management'],
    ['chorro', 'stream, jet, spurt'],
    ['sucesivamente', 'successively, one by one'],
    ['estimación', 'estimate'],
    ['directivo', 'executive, manager'],
    ['pupila', 'pupil'],
    ['terminal', 'terminal, final'],
    ['asimilar', 'to assimilate'],
    ['inmigrante', 'immigrant'],
    ['jaula', 'cage, crate, playpen'],
    ['directivo', 'managerial, administrative'],
    ['proximidad', 'proximity'],
    ['traslado', 'transfer'],
    ['tranquilizar', 'to calm down'],
    ['manuscrito', 'manuscript'],
    ['cabecera', 'head, header'],
    ['pudrir', 'to rot, decay'],
    ['guapo', 'handsome, beautiful'],
    ['eliminación', 'elimination'],
    ['bloqueo', 'blockade, block'],
    ['insólito', 'unusual, uncommon'],
    ['lente', 'lens, [pl] glasses'],
    ['suprimir', 'to suppress, delete'],
    ['porción', 'part, portion, share'],
    ['recobrar', 'to recover, regain'],
    ['insultar', 'to insult, berate'],
    ['salsa', 'sauce, salsa'],
    ['ventanilla', '(vehicle) window'],
    ['lámina', 'sheet (of metal)'],
    ['tenso', 'tight, tense'],
    ['coordinador', 'coordinator, organizer'],
    ['procesar', 'to process, prosecute'],
    ['reservado', 'reserved, booked'],
    ['correspondencia', 'correspondence, connection'],
    ['yacimiento', 'deposit, field'],
    ['presentir', 'to sense in advance'],
    ['mueca', 'face, grimace'],
    ['resuelto', 'resolved, determined'],
    ['riguroso', 'rigorous, severe'],
    ['recorte', 'clipping, cutting, trimming'],
    ['cardenal', 'cardinal'],
    ['barrer', 'sweep, clean out'],
    ['gusano', 'worm, caterpillar'],
    ['apuesta', 'wager, bet'],
    ['bruja', 'witch, hag'],
    ['complejidad', 'complexity'],
    ['protocolo', 'protocol, convention'],
    ['dictador', 'dictator'],
    ['francamente', 'frankly, openly'],
    ['espera', 'wait'],
    ['guión', 'script, hyphen'],
    ...
    ['sancionar', 'to sanction, penalize'],
    ['carpeta', 'folder, file'],
    ['trasero', 'behind, back'],
    ['apetito', 'appetite'],
    ...
    ['naval', 'naval'],
    ['volcán', 'volcano'],
    ['presumir', 'to boast, show off, suppose'],
    ['corteza', 'bark, crust, rind, peel'],
    ['adorno', 'decoration, adornment'],
    ['económicamente', 'economically'],
    ['disculpa', 'apology, excuse'],
    ['censura', 'censorship, criticism'],
    ['ampliación', 'enlargement, extension'],
    ['refugiar', 'to take shelter, give refuge'],
    ['honrar', 'to honor'],
    ['muralla', 'city wall'],
    ['rondar', 'patrol, serenade'],
    ...
    ['desplazamiento', 'movement, removal'],
    ['reportaje', 'news report'],
    ['fundir', 'to melt, cast, smelt'],
    ['retraso', 'delay'],
    ['acorde', 'agreement, accord'],
    ['rescate', 'rescue, ransom'],
    ['estrés', 'stress'],
    ['cría', 'breeding, raising'],
    ['observador', 'observer'],
    ['editorial', 'editorial'],
    ['manual', 'manual, handbook'],
    ['multa', 'fine, penalty, citation'],
    ['catalán', 'Catalan'],
    ['comunión', 'communion'],
    ['flexible', 'flexible'],
    ['arco', 'arch, arc, bow'],
    ...
    ['incidencia', 'ocurrence, impact'],
    ['tumor', 'tumor, growth'],
    ['enfatizar', 'to emphasize, stress'],
    ['monarca', 'monarch'],
    ['recitar', 'to recite'],
    ...
    ['recortar', 'to trim, cut off, clip'],
    ['tramo', 'section, stretch, plot'],
    ['camioneta', 'van, bus'],
    ['polaco', 'Polish'],
    ...
    ['temeroso', 'fearful'],
    ['comprador', 'buyer'],
    ['decente', 'respectable, decent'],
    ['comprometido', 'committed, engaged'],
    ['abundancia', 'abundance'],
    ['espiar', 'to spy on'],
    ['especificar', 'to specify, itemize'],
    ...
    ['incorporación', 'inclusion, incorporation'],
    ['ama', 'housekeeper, housewife'],
    ['bolso', 'bag, purse'],
    ['canciller', 'chancellor, ambassador'],
    ['públicamente', 'publicly, in public'],
    ['tolerancia', 'tolerance'],
    ['idiota', 'idiot, dunce'],
    ['catálogo', 'catalog'],
    ['constatar', 'to prove, verify'],
    ['deficiencia', 'deficiency, lack'],
    ['atormentar', 'to torture, torment'],
    ['solemne', 'solemn'],
    ['compatriota', 'fellow countryman'],
    ['frotar', 'to rub, scrub'],
    ['comisaría', 'police station'],
    ['metodología', 'methodology, method'],
    ['millonario', 'millionaire'],
    ['bote', 'boat, container'],
    ['bicho', 'bug, creature'],
    ['hongo', 'mushroom, fungus'],
    ...
    ['valiente', 'brave, courageous, bold'],
    ['olla', 'pot, kettle'],
    ['encajar', 'to insert, fit well'],
    ['limón', 'lemon, lime'],
    ['complementario', 'additional, complementary'],
    ['narrador', 'narrator'],
    ['contrastar', 'to contrast'],
    ['simultáneamente', 'simultaneously'],
    ['resistente', 'tough, resistant, durable'],
    ...
    ['fidelidad', 'faithfulness, accuracy'],
    ['complicación', 'complication'],
    ['mostrador', 'counter, desk'],
    ['escurrir', 'to drip, drain, trickle'],
    ['apelar', 'to call upon, appeal to'],
    ['goma', 'rubber'],
    ['agricultor', 'farmer'],
    ['vejez', 'old age'],
    ...
    ['mango', 'handle, mango'],
    ['donación', 'donation'],
    ['denominación', 'name, denomination'],
    ['parroquia', 'parish'],
    ...
    ['decadencia', 'decline, decay'],
    ['alquiler', 'rent, rental'],
    ['invento', 'invention'],
    ['diseñador', 'designer, stylist'],
    ['alambre', 'wire'],
    ['migración', 'migration'],
    ...
    ['ascensor', 'elevator'],
    ['congelar', 'to freeze'],
    ['embarcar', 'to embark, load'],
    ['simular', 'to pretend, simulate'],
    ['encaje', 'lace'],
    ['peón', 'unskilled laborer, field hand'],
    ['abusar', 'to abuse'],
    ['vaciar', 'to empty, pour out'],
    ['testamento', 'will, testament'],
    ['bono', 'bond, certificate, voucher'],
    ['súbito', 'sudden'],
    ['arruga', 'wrinkle'],
    ['síndrome', 'syndrome'],
    ['estatuto', 'statute'],
    ['rebelde', 'rebel, insurgent'],
    ...
    ['índole', 'nature, temperament'],
    ['latir', 'to beat (heart)'],
    ['detenido', 'prisoner, detainee'],
    ['uruguayo', 'Uruguayan'],
    ['rocío', 'dew'],
    ['seriedad', 'seriousness'],
    ['invención', 'invention, contrivance'],
    ['reprimir', 'to repress'],
    ...
    ['partidario', 'in favor of, supportive'],
    ['reanudar', 'to renew, resume'],
    ['bruto', 'brutal, coarse, clumsy'],
    ['desfile', 'parade, line, formation'],
    ['harina', 'flour'],
    ['pedagógico', 'pedagogical, teaching'],
    ['gemir', 'to moan, groan'],
    ['caracol', 'snail, shell'],
    ['estética', 'aesthetics'],
    ['revivir', 'to revive'],
    ...
    ['impregnar', 'to impregnate, permeate'],
    ['víspera', 'eve'],
    ['enlazar', 'to link, connect'],
    ['prudente', 'sensible, prudent'],
    ['incapacidad', 'inability, incompetence'],
    ['defensivo', 'defensive'],
    ['antena', 'antenna'],
    ['fotográfico', 'photographic'],
    ['charco', 'pool, puddle'],
    ['bandeja', 'tray'],
    ['maniobra', 'maneuver, operation'],
    ['romance', 'romance'],
    ['sofá', 'sofa, couch'],
    ['moderado', 'moderate, mild'],
    ['embarcación', 'ship, embarkation'],
    ['espuma', 'foam, lather'],
    ['alojar', 'to host, accommodate'],
    ['atómico', 'atomic, nuclear'],
    ['esplendor', 'splendor'],
    ['capitalista', 'capitalist'],
    ['dialogar', 'to confer, talk'],
    ['fundamentar', 'to base, found'],
    ['justificación', 'justification'],
    ['decorado', 'decorated'],
    ['desierto', 'deserted, desolate'],
    ['descalzo', 'barefoot'],
    ...
    ['cazador', 'hunter'],
    ['amontonar', 'to gather, accumulate'],
    ...
    ['cívico', 'civic, civil'],
    ['novelista', 'novelist'],
    ['sobrepasar', 'to excel, outperform'],
    ['predecir', 'to predict'],
    ['arqueológico', 'archaeological, archeological'],
    ['transacción', 'transaction, deal'],
    ['desencadenar', 'to unleash, unchain'],
    ['ancho', 'width'],
    ['asentamiento', 'settlement, colony'],
    ['intuir', 'to sense'],
    ['contradictorio', 'contradictory'],
    ['respetuoso', 'respectful'],
    ['financiación', 'financing, funding'],
    ['costero', 'coastal'],
    ['restablecer', 'to re-establish, restore'],
    ['andino', 'Andean'],
    ...
    ['especulación', 'speculation, conjecture'],
    ['agachar', 'to duck, bend down'],
    ['intacto', 'intact'],
    ['pirámide', 'pyramid'],
    ['vibración', 'vibration'],
    ['étnico', 'ethnic'],
    ...
    ['tentar', 'to tempt, entice'],
    ['puramente', 'purely, simply'],
    ['milenio', 'millennium'],
    ...
    ['discreto', 'discreet, tactful'],
    ['fiscalía', 'office of the public prosecutor'],
    ['natal', 'native, birth'],
    ['prolongado', 'prolonged, lengthy'],
    ['negativa', 'negative, denial'],
    ['asombroso', 'amazing'],
    ['coherente', 'coherent, connected'],
    ['potenciar', 'to strengthen, boost'],
    ['segmento', 'segment, sector'],
    ['contundente', 'decisive, blunt, forceful'],
    ['ingenuo', 'naïve, ingenuous'],
    ['minúsculo', 'minute, insignificant'],
    ['inspector', 'inspector'],
    ['auge', 'peak, boom'],
    ['torpe', 'clumsy, awkward, slow'],
    ['pureza', 'purity, chastity'],
    ['ramo', 'bunch (of flowers), branch'],
    ['auditorio', 'hearing, auditorium'],
    ['tregua', 'truce, rest'],
    ['escalón', 'stair, rung,'],
    ['duque', 'duke'],
    ...
    ['originario', 'native to, originate from'],
    ['lateral', 'side, lateral'],
    ['condicionar', 'to condition, determine'],
    ...
    ['maquillaje', 'makeup'],
    ['encargo', 'job, order, errand'],
    ['corrección', 'correction, amendment'],
    ['lealtad', 'loyalty, faithfulness'],
    ['atentar', 'to attack, attempt, threaten'],
    ['diferir', 'to differ'],
    ['frasco', 'bottle, jar, flask'],
    ['montaje', 'assembly, staging'],
    ['concha', 'shell'],
    ['conejo', 'rabbit'],
    ...
    ['requerimiento', 'requirement, request, summons'],
    ['mediocre', 'mediocre'],
    ['rienda', 'rein, restraint'],
    ['derribar', 'to knock down, overthrow'],
    ['compacto', 'compact, dense'],
    ['teclado', 'keyboard'],
    ['tanque', 'tank, large container'],
    ['helicóptero', 'helicopter'],
    ['envidiar', 'to envy'],
    ['capacitar', 'to qualify, prepare'],
    ['aflojar', 'to loosen'],
    ['maldad', 'evil, wickedness'],
    ['brusco', 'brusque, abrupt, sudden'],
    ['envejecer', 'to age, grow old'],
    ['estrechar', 'to tighten, make closer'],
    ['cagar', 'to dirty, crap'],
    ['atleta', 'athlete'],
    ['reformar', 'to reform, renovate'],
    ['suplicar', 'to beg'],
    ['desconfianza', 'distrust'],
    ['forzado', 'forced, stiff'],
    ['vasco', 'Basque'],
    ['resurrección', 'resurrection'],
    ['monumental', 'monumental'],
    ['trascendencia', 'transcendent nature, significance'],
    ['ecuación', 'equation'],
    ['seriamente', 'seriously'],
    ['secuestro', 'kidnapping, seizure'],
    ['apuro', 'trouble, predicament'],
    ['nulo', 'void, null'],
    ['quehacer', 'task, job, chore'],
    ['amparo', 'protection, shelter'],
    ['irónico', 'ironic, mocking'],
    ['burbuja', 'bubble'],
    ['insertar', 'to insert, put in'],
    ...
    ['rojizo', 'reddish, ruddy'],
    ['invocar', 'to invoke'],
    ['pulsar', 'to press, beat, strike, throb'],
    ['impaciente', 'impatient'],
    ['apunte', 'note, annotation'],
    ['llano', 'flat, level, plain'],
    ['sofisticado', 'sophisticated'],
    ['filtro', 'filter, screening'],
    ['primordial', 'fundamental, primary'],
    ['inolvidable', 'unforgettable'],
    ['plantilla', 'template, stencil'],
    ['espanto', 'fright, ghost'],
    ...
    ['vinculación', 'link, connection'],
    ['difunto', 'deceased'],
    ['plenitud', 'fullness, abundance'],
    ['interrupción', 'interruption'],
    ['disgusto', 'disgust, annoyance'],
    ['cómico', 'comic'],
    ['entonar', 'to intone, sing, modulate'],
    ['exhibición', 'exhibition, showing'],
    ['reseña', 'review, outline'],
    ['despegar', 'to detach, take off (plane)'],
    ['disponibilidad', 'availability'],
    ['previsión', 'forecast, precaution'],
    ['implacable', 'relentless, implacable'],
    ['futbolista', 'soccer player'],
    ['marea', 'wave, tide, ebb'],
    ['relevancia', 'relevance'],
    ['siniestro', 'sinister'],
    ['pillar', 'to capture, catch'],
    ['récord', 'record'],
    ['tóxico', 'toxic'],
    ['formidable', 'formidable, tremendous'],
    ['legalmente', 'legally'],
    ['ecosistema', 'ecosystem'],
    ['internar', 'to confine'],
    ['ráfaga', 'burst, gust'],
    ['manchado', 'stained, dirty'],
    ['mecánica', 'mechanics, mechanism'],
    ['inclusión', 'inclusion'],
    ['apto', 'appropriate, fit, able'],
    ['restante', 'remaining, leftover'],
    ['fronterizo', 'border'],
    ['encierro', 'confinement, imprisonment'],
    ['prevalecer', 'to prevail'],
    ['cheque', 'check'],
    ['dudoso', 'doubtful, dubious'],
    ['postular', 'to postulate, nominate'],
    ['portador', 'bearer, carrier'],
    ['confederación', 'confederation, alliance'],
    ['film', 'film, movie'],
    ['portavoz', 'spokesperson, mouthpiece'],
    ...
    ['cordón', 'cord, yarn, braid'],
    ['melancolía', 'melancholy, depression'],
    ['arrodillar', 'to kneel'],
    ['plancha', '(electric) iron, plate, sheet'],
    ['dispersar', 'to disperse, scatter, spread'],
    ['artesano', 'artisan, craftsman'],
    ['movilidad', 'mobility, movement'],
    ['zapatilla', 'slipper, shoe'],
    ['intuición', 'intuition'],
    ...
    ['narrativo', 'narrative'],
    ['constructor', 'builder, construction'],
    ['térmico', 'thermal, heated'],
    ['poblador', 'settler, resident'],
    ...
    ['bodega', 'cellar, pantry, warehouse'],
    ['optimismo', 'optimism'],
    ['congregación', 'congregation'],
    ['accesible', 'accessible'],
    ['exceder', 'to excel, exceed'],
    ['flora', 'flora'],
    ['monasterio', 'monastery, convent'],
    ['cuerno', 'horn, antler'],
    ['ajedrez', 'chess'],
    ['manual', 'manual'],
    ['diosa', 'goddess'],
    ['óptimo', 'optimum'],
    ['polémico', 'controversial, polemical'],
    ['firmeza', 'firmness'],
    ['narrativa', 'narrative, story'],
    ['ropero', 'wardrobe, closet'],
    ['bombero', 'firefighter'],
    ['guardián', 'guardian'],
    ['relajar', 'to relax'],
